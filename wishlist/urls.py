...
urlpatterns = [
    ...
    path('AdminRemoveCategory/', views.AdminRemoveCategory,
         name='AdminRemoveCategory'),
    path('AdminViewCustomers/', views.Admin_View_Customers,
         name='Admin View Customers'),
    path('Admin_View_Feedback/', views.Admin_View_Feedback,
         name='Admin View Admin_View_Feedback'),
    path('Admin_View_Shop/', views.Admin_View_Shop,
         name='Admin View Admin_View_Shop'),

    # -------------customer------------------
    path('Customerviewproduct/', views.Customerviewproduct,
         name="Customerviewproduct"),
    path('CustomerViewMyBooking/', views.CustomerViewMyBooking,
         name="CustomerViewMyBooking"),
    path('CustomerViewOrders/', views.CustomerViewOrders,
         name="CustomerViewOrders"),
    path('CustomerShopping/', views.CustomerShopping, name='CustomerShopping'),
    path('CustomerViewProfile/', views.Customer_View_Profile,
         name='Customer View Profile'),
    path('CustomerViewProDetails/', views.CustomerViewProDetails,
         name='CustomerViewProDetails'),
    path('CustomerViewCart/', views.CustomerViewCart, name="CustomerViewCart"),
    path('Customer_AddFeedback/', views.Customer_AddFeedback,
         name="Customer_AddFeedback"),
    path('CustomerViewProCategory/', views.CustomerViewProCategory,
         name="CustomerViewProCategory"),
    ...
    path('ShopViewMyProduct/', views.Shop_View_My_Product,
         name='Shop View My Product'),
    ...
    path('Shop_View_payment/', views.Shop_View_payment,
         name='Shop View Shop_View_payment'),
